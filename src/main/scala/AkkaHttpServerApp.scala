...
import model.service.CustomerServicePlay
import persistence.{CustomerRepository, CustomerRepositoryPlay}
...
object AkkaHttpServerApp extends App {
  ...
  val customerRepository = new CustomerRepositoryPlay(databaseConfigProvider)
  val customerService = new CustomerServicePlay(customerRepository)
